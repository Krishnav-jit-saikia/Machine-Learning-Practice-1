...
select salary from employee order by salary ;-- for accending order
select salary from employee order by salary desc ;  -- for dcending order

# Limit -- Helps to retrive specific number of records ( extracting top records )

select * from employee limit 3 ;

# offset -- to skip the rows from top 
